...
"""
    ...
    void "can use default jOOQ version and edition"() {
        ...
        then:
        result.output.contains('org.jooq:jooq-codegen:3.20.11')
        result.output.contains('org.jooq:jooq:3.20.11')
...
"""
    ...
    void "can set custom jOOQ edition"() {
        ...
        result.output.contains('org.jooq.trial:jooq-codegen:3.20.11 FAILED')
        !result.output.contains('org.jooq.trial:jooq:3.20.11')

        when:
        result = runWithArguments('dependencies', '--configuration', 'compileClasspath')

        then:
        !result.output.contains('org.jooq.trial:jooq-codegen:3.20.11')
        result.output.contains('org.jooq.trial:jooq:3.20.11 FAILED')
    }
...
"""
        ...
        result.output.contains('org.jooq.pro:jooq-codegen:3.20.11 FAILED')
        !result.output.contains('org.jooq.pro:jooq:3.20.11')

        when:
        result = runWithArguments('dependencies', '--configuration', 'compileClasspath')

        then:
        !result.output.contains('org.jooq.pro:jooq-codegen:3.20.11')
        result.output.contains('org.jooq.pro:jooq:3.20.11 FAILED')
    }
