...
"""
    ...
    void "can use default jOOQ version and edition"() {
        ...
        then:
        result.output.contains('org.jooq:jooq-codegen:3.20.3')
        result.output.contains('org.jooq:jooq:3.20.3')
...
"""
    ...
    void "can set custom jOOQ edition"() {
        ...
        result.output.contains('org.jooq.trial:jooq-codegen:3.20.3 FAILED')
        !result.output.contains('org.jooq.trial:jooq:3.20.3')

        when:
        result = runWithArguments('dependencies', '--configuration', 'compileClasspath')

        then:
        !result.output.contains('org.jooq.trial:jooq-codegen:3.20.3')
        result.output.contains('org.jooq.trial:jooq:3.20.3 FAILED')
    }
...
"""
        ...
        result.output.contains('org.jooq.pro:jooq-codegen:3.20.3 FAILED')
        !result.output.contains('org.jooq.pro:jooq:3.20.3')

        when:
        result = runWithArguments('dependencies', '--configuration', 'compileClasspath')

        then:
        !result.output.contains('org.jooq.pro:jooq-codegen:3.20.3')
        result.output.contains('org.jooq.pro:jooq:3.20.3 FAILED')
    }
