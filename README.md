...
```groovy
jooq {
  version = '3.16.12'  // the default (can be omitted)
...
be seen on the jOOQ generation tool's [Configuration](https://github.com/jOOQ/jOOQ/blob/version-3.16.12/jOOQ-meta/src/main/java/org/jooq/meta/jaxb/Configuration.java) class, or
...
jooq {
    version = '3.16.12'  // default (can be omitted)
...
jooq {
    version.set("3.16.12")  // default (can be omitted)
...
+ Next - TBD
+ 7.2 - Ensure build caching compatibility with Gradle 8. Upgrade to jOOQ 3.16.12.
