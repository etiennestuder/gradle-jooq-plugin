...
```groovy
jooq {
  version = '3.17.4'  // the default (can be omitted)
...
```kotlin
jooq {
  version.set("3.17.4")  // the default (can be omitted)
...
be seen on the jOOQ generation tool's [Configuration](https://github.com/jOOQ/jOOQ/tree/version-3.17.4/jOOQ-meta/src/main/java/org/jooq/meta/jaxb) class, or
...
jooq {
    version = '3.17.4'  // default (can be omitted)
